...
## Note about Patch Tuesday and Patch Wednesday

Every Tuesday and Wednesday from 5:30 - 8:30AM EST is a planned maintenance window with patches and other maintenance work done by the PUL IT Operations team.  Patch Tuesday applies to staging servers.  Patch Wednesday applies to production and QA servers.  Alerts caused by planned maintenance work may appear in our tools during these windows.  Questions about work being done in this window can best be directed to the #infrastructure channel on Slack.  
...
*  [Honeybadger](https://app.honeybadger.io/projects) for *errors* in the following RDSS applications:
   ...
   * [orcid errors](https://app.honeybadger.io/projects/114910/faults?q=-is%3Aresolved+-is%3Aignored) and [orcid uptime](https://pulmonitor.princeton.edu/production/check_mk/index.py?start_url=%2Fproduction%2Fcheck_mk%2Fview.py%3Fhost%3Dorcid-prod1%26site%3Dproduction%26view_name%3Dhoststatus)
